...
**Five structural quirks discovered during HOM-347 / HOM-351 / HOM-358 / HOM-360 deploy** that any future change to `deploy.sh` / Dockerfile generation / compose volumes must preserve:
